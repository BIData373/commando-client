...
export function useWorkspaceSettings(
	urlName: string,
	options?: QueryOptions<IWorkspaceSettings>,
) {
	return useQuery({
		...
		queryFn: async (): Promise<IWorkspaceSettings> =>
			USE_MOCK_API
				...
				: await sendRequest<IWorkspaceSettings>({
						method: "GET",
						url: `${workspaceSettingsUrl}/${urlName}`,
					}),
		...options,
	});
}
...
export function useUpdateWorkspaceSettings(
	urlName: string,
	options?: MutationOptions<IUpdateWorkspaceSettings>,
) {
