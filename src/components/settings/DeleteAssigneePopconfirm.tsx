...
import { getListAssigneesQueryKey, useDeleteAssignee } from "src/api/assignee/assignee"
...
export function DeleteAssigneePopconfirm({
    ...
    return (
        <ConfirmPopover
            ...
            description={<>האם אתה בטוח? מחיקת האחראי תבטל את שיוך ההנחיות שהוא קיבל (סה"כ {tasksCount > 0 ? tasksCount : "."} הנחיות פעילות)<br />הנחיות אלו ימשיכו להופיע בלשכה</>}
            confirmLabel="מחק"
            cancelLabel="לא"
            isPending={isPending}
            side="bottom"
