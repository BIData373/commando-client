...
export const environmentKeys = {
	...
	responsibleGroups: (id: string) =>
		[environmentsUrl, id, "responsibleGroups"] as const,
};
...
export function useEnvironments(
	options?: QueryOptions<IEnvironmentWithRole[]>,
) {
	return useQuery({
...
export function useCreateEnvironment(
	options?: MutationOptions<ICreateEnvironment>,
) {
...
export function useEnvironmentMembers(
	envId: string,
	options?: QueryOptions<IEnvironmentMember[]>,
) {
	return useQuery({
	...
	return useQuery({
		...
		queryFn: async (): Promise<ITag[]> =>
			USE_MOCK_API
				...
				: await sendRequest<ITag[]>({
						method: "GET",
						url: `${environmentsUrl}/${envId}/tags`,
					}),
		enabled: !!envId,
		...options,
	});
...
export function useResponsibleGroups(
	envId: string,
	options?: QueryOptions<IResponsibleGroup[]>,
) {
	return useQuery({
...
export function useDeleteResponsibleGroup(
	envId: string,
