...
export const mockComments: IComment[] = [
  // דיווחים להנחיה 1 (תקציב שנתי)
  {
    ...
    content: 'קיבלתי את הנתונים ממדור הכספים. מתחיל לעבוד על הטיוטה הראשונה.',
  ...
  },
  {
    ...
    content: 'סיימתי את החלק של תקציב המבצעים. מצורף לתיק המשותף. @רס"ן לוי — בדוק ואשר.',
  ...
  },
  {
    ...
    instructionId: 'inst-02-aaaa-bbbb-cccccccccccc',
    user: mockUserSummaries[3],
    content: 'הופץ ב-3 ערוצים. התקבלו 12 מועמדים. אבצע סינון ראשוני עד סוף השבוע.',
  ...
  },
  {
    ...
    instructionId: 'inst-02-aaaa-bbbb-cccccccccccc',
    user: mockUserSummaries[3],
    content: 'סוננו 4 מועמדים מתאימים. מתאם ועדת קבלה לשבוע הבא. תג"ב מתקרב — יש לזרז.',
  ...
  // דיווחים להנחיה 8 (שדרוג שרתים)
  {
    ...
    user: mockUserSummaries[3],
    content: 'לתשומת לב — תג"ב חלף! השרת הראשי בסיכון תפעולי. יש לסגור בדחיפות מבצעית.',
