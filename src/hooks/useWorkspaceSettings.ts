    ...
    return useQuery({
        ...
        queryFn: async (): Promise<IWorkspaceSettings> =>
            USE_MOCK_API
                ...
                : await sendRequest<IWorkspaceSettings>({ method: 'GET', url: `${workspaceSettingsUrl}/${urlName}` }),
        ...options,
    });
}
    ...
    return useMutation({
        mutationFn: async (data: IUpdateWorkspaceSettings) =>
            USE_MOCK_API
                ...
                : await sendRequest<IWorkspaceSettings>({ method: 'PATCH', url: `${workspaceSettingsUrl}/${urlName}`, data }),
        ...options,
        onSuccess: (...args) => {
